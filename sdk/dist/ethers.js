...
export class Zamm {
    ...
    async quote(params) {
        ...
        const [bestResult, splitResult, quotesResult, curveResult] = await Promise.allSettled([
            this.quoter.buildBestSwapViaETHMulticall(recipient, refundTo, false, tokenIn, tokenOut, amount, BigInt(slippageBps), deadline),
            this.quoter.buildSplitSwap(recipient, tokenIn, tokenOut, amount, BigInt(slippageBps), deadline),
